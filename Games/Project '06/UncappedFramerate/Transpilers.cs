...
namespace UncappedFramerate
{
    ...
    {
        public static IEnumerable<CodeInstruction> ReplaceFixedDeltaTime(IEnumerable<CodeInstruction> in_instructions, float in_value)
        {
            var newInstructions = new List<CodeInstruction>();

            foreach (var instruction in in_instructions)
            {
