...
#define TRS_GET_HOOK_ARGS(FUNCTION_NAME, PARAMS) \
    BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_TRANSFORM(GET_HOOK_ARG, FUNCTION_NAME, PARAMS))
...
#define TRS_GET_HOOK_PARAMS(FUNCTION_NAME, PARAMS) \
    BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_TRANSFORM(GET_HOOK_PARAM, FUNCTION_NAME, PARAMS))
...
#define DECLARE_PREFIX_HOOK(RETURN_TYPE, FUNCTION_NAME, SYMBOL_NAME, PARAMS) \
    RECOMP_HOOK(SYMBOL_NAME) void prefix_##FUNCTION_NAME(TRS_GET_HOOK_PARAMS(FUNCTION_NAME, PARAMS))
...
#define DECLARE_POSTFIX_HOOK(RETURN_TYPE, FUNCTION_NAME, SYMBOL_NAME, PARAMS)                   \
    ...
    RETURN_TYPE impl_##FUNCTION_NAME(TRS_GET_HOOK_PARAMS(FUNCTION_NAME, PARAMS));               \
    RECOMP_HOOK_RETURN(SYMBOL_NAME) RETURN_TYPE postfix_##FUNCTION_NAME()                       \
    {                                                                                           \
        GET_RETURN(RETURN_TYPE) impl_##FUNCTION_NAME(TRS_GET_HOOK_ARGS(FUNCTION_NAME, PARAMS)); \
    }                                                                                           \
    RETURN_TYPE impl_##FUNCTION_NAME(TRS_GET_HOOK_PARAMS(FUNCTION_NAME, PARAMS))
