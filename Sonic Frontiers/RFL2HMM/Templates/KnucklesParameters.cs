...
public class KnucklesParametersClass
{
    ...
    public struct KnucklesParamComboPunch1
    {
        ...
        [FieldOffset(48)] public float motionScale;
        [FieldOffset(52)] public float motionSpeedRate;
    }
    ...
    public struct CommonPackageKnuckles
    {
        ...
        [FieldOffset(16592)] public KnucklesParamComboUppercut comboUppercut;
    }
    ...
    {
        [FieldOffset(0)]  public float minSpeed;
        [FieldOffset(4)]  public float minSpeedRingMax;
        [FieldOffset(8)]  public float fallSpeed;
        [FieldOffset(12)] public float fallAccel;
        [FieldOffset(16)] public float maxSteerSpeed;
        [FieldOffset(20)] public float rollSpeed;
        [FieldOffset(24)] public float neutralRollSpeed;
        [FieldOffset(28)] public float yawSpeed;
        [FieldOffset(32)] public float maxRollAngle;
        [FieldOffset(36)] public float height;
        [FieldOffset(40)] public float startHeight;
        [FieldOffset(44)] public bool restartable;
        [FieldOffset(48)] public KnucklesParamGlidingCamera camera;
    }

    [StructLayout(LayoutKind.Explicit, Size = 20)]
    public struct KnucklesParamCyKnuckle
    {
        [FieldOffset(0)]  public float findRadius;
        [FieldOffset(4)]  public uint numNotifies;
        [FieldOffset(8)]  public float activeRadius;
        [FieldOffset(12)] public float findDistanceStomp;
        [FieldOffset(16)] public float findRadiusStomp;
    }

    [StructLayout(LayoutKind.Explicit, Size = 16)]
    public struct KnucklesParamCyKnuckleDig
    {
        [FieldOffset(0)]  public float diveScale;
        [FieldOffset(4)]  public float speed;
        [FieldOffset(8)]  public float stompingAttackScale;
        [FieldOffset(12)] public bool alsoStomping;
    }

    [StructLayout(LayoutKind.Explicit, Size = 4)]
    public struct KnucklesParamCyKnuckleWarp
    {
        [FieldOffset(0)] public float appearWaitTime;
    }
    ...
    {
        [FieldOffset(0)]  public float appearWaitTime;
        [FieldOffset(4)]  public uint ringWeight;
        [FieldOffset(8)]  public uint superRingWeight;
        [FieldOffset(12)] public uint skillPieceWeight;
        [FieldOffset(16)] public uint numRings;
        [FieldOffset(20)] public uint numSuperRings;
        [FieldOffset(24)] public uint numSkillPieces;
        [FieldOffset(28)] public uint skillPieceExp;
    }

    [StructLayout(LayoutKind.Explicit, Size = 56)]
    public struct KnucklesParamMaximumHeatKnuckle
    {
        [FieldOffset(0)]  public float lockonLevelUpSpanTime__arr0;
        [FieldOffset(4)] public float lockonLevelUpSpanTime__arr1;
        [FieldOffset(8)] public float lockonLevelUpSpanTime__arr2;
        [FieldOffset(12)] public float lockonLevelUpSpanTime__arr3;
        [FieldOffset(16)] public float lockonLevelUpSpanTime__arr4;
        [FieldOffset(20)] public float lockonSearchDistance;
        [FieldOffset(24)] public float lockonSearchDistanceFar;
        [FieldOffset(28)] public float speed;
        [FieldOffset(32)] public float followSpeed;
        [FieldOffset(36)] public float followTime;
        [FieldOffset(40)] public CString hitStopObject;
    }

    [StructLayout(LayoutKind.Explicit, Size = 4)]
    public struct KnucklesParamDrillBoost
    {
        [FieldOffset(0)] public float prepareTime;
    }
    ...
    public struct ModePackageKnuckles
    {
        ...
        [FieldOffset(2236)] public KnucklesParamCyKnuckleWarp cyknuckleWarp;
        [FieldOffset(2240)] public KnucklesParamCyKnucklePopupItem cyknucklePopupItem;
        [FieldOffset(2244)] public KnucklesParamCyKnuckleAppearGimmick cyknuckleAppearGimmick;
        [FieldOffset(2280)] public KnucklesParamMaximumHeatKnuckle maximumHeatKnuckle;
        [FieldOffset(2336)] public KnucklesParamDrillBoost drillBoost;
        [FieldOffset(2344)] public PlayerParamSpinBoost spinBoost;
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 19680)]
    public struct KnucklesParameters
    {
        [FieldOffset(0)]     public CommonPackageKnuckles common;
        [FieldOffset(16656)] public ModePackageKnuckles forwardView;
        [FieldOffset(19248)] public WaterModePackage water;
    }
