...
public class EnemyRobberConfigClass
{
    ...
    public struct EnemyRobberConfig
    {
        ...
        [FieldOffset(60)] public EnemyRobberLevelConfig levelParams__arr0;
        [FieldOffset(76)] public EnemyRobberLevelConfig levelParams__arr1;
        [FieldOffset(92)] public EnemyRobberLevelConfig levelParams__arr2;
        [FieldOffset(108)] public EnemyRobberLevelConfig levelParams__arr3;
        [FieldOffset(124)] public EnemyRobberLevelConfig levelParams__arr4;
    }
