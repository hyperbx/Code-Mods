...
public class MiniBossSkierConfigClass
{
    ...
    {
        [FieldOffset(0)]   public int level;
        [FieldOffset(4)]   public MiniBossSkierBattlePhaseParam phaseParam__arr0;
        [FieldOffset(36)] public MiniBossSkierBattlePhaseParam phaseParam__arr1;
        [FieldOffset(68)] public MiniBossSkierBattlePhaseParam phaseParam__arr2;
    ...
    public struct MiniBossSkierConfig
    {
        ...
        [FieldOffset(320)] public MiniBossSkierLevelParam levelParams__arr0;
        [FieldOffset(376)] public MiniBossSkierLevelParam levelParams__arr1;
        [FieldOffset(432)] public MiniBossSkierLevelParam levelParams__arr2;
        [FieldOffset(488)] public MiniBossSkierLevelParam levelParams__arr3;
        [FieldOffset(544)] public MiniBossSkierLevelParam levelParams__arr4;
        [FieldOffset(600)] public MiniBossSkierLevelBand levelBand__arr0;
        [FieldOffset(828)] public MiniBossSkierLevelBand levelBand__arr1;
        [FieldOffset(1056)] public MiniBossSkierLevelBand levelBand__arr2;
        [FieldOffset(1284)] public MiniBossSkierLevelBand levelBand__arr3;
        [FieldOffset(1512)] public MiniBossSkierLevelBand levelBand__arr4;
    }
