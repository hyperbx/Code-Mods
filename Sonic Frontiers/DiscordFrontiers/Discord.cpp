void Discord::Init()
{
    ...
    Discord::Commit(State, Details, LargeImageKey, SmallImageKey, 0);
}

void Discord::Commit(std::string in_state, std::string in_details, std::string in_largeImageKey, std::string in_smallImageKey, time_t in_startTime)
{
