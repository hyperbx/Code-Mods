...
CL_SCAN_SIGNATURE(m_SigStopEffects, 0x14BC65500, "\x40\x53\x48\x83\xEC\x20\x48\x89\xCB\xE8\xCC\xCC\xCC\xCC\x48\x85\xC0", "xxxxxxxxxx????xxx");
...
public:
	...
	static void SetAnimationEffect(int64_t in_pSonicContext, bool in_enabled, const char* in_pEffectName = "")
	{
		...
		{
			FUNCTION_PTR(int64_t, __fastcall, fpStopAnimationEffects, m_SigStopEffects(), int64_t in_pSonicContext);
